...
const News = ({ country, category, articles, setArticles }) => {
    // https://newsapi.org/v2/top-headlines?country=de&category=business&apiKey=eddbd745f01d4bcca14de59e30bf6238
        ...
        <>
            {
                loading ? <div className="bg-gray-200 dark:bg-gray-800  h-screen flex flex-col gap-3 items-center justify-center">
                    ...
                    <div className=" bg-gray-200 dark:bg-gray-800 py-30 px-4 md:px-0">
                        <p className="text-xl md:text-3xl px-8 pb-8 font-bold text-9xl text-blue-800 dark:text-white ">Connecting You to the World's Stories...</p>
